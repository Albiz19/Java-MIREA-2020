...
public class RestaurantOrder<Item> implements Order {
    ...
    @Override
    public boolean addFront(ru.Albiz19.java2020.pr29.ex29_1.Item x) {
        return false;
    }

    @Override
    public boolean addFront(ru.Albiz19.java2020.pr29.ex29_1.Item x, HashMap<String, Order> hashMap) {
        return false;
    }
    ...
    @Override
    public int remove(ru.Albiz19.java2020.pr29.ex29_1.Item x) {
        return 0;
    }

    @Override
    public int remove(ru.Albiz19.java2020.pr29.ex29_1.Item x, HashMap<String, Order> hashMap) {
        return 0;
    }
    ...
    @Override
    public ru.Albiz19.java2020.pr29.ex29_1.Item getOrders(HashMap<String, Order> hashMap) {
        return null;
    }

    @Override
    public ru.Albiz19.java2020.pr29.ex29_1.Item massOrders() {
        return null;
    }

    @Override
    public ru.Albiz19.java2020.pr29.ex29_1.Item massOrdersSorted() {
        return null;
    }
    ...
    @Override
    public int quantity(ru.Albiz19.java2020.pr29.ex29_1.Item x) {
        return 0;
    }

    @Override
    public ru.Albiz19.java2020.pr29.ex29_1.Item massOrdersnames() {
        return null;
    }
